...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rate'
        db.create_table(u'recette_rate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recette.Recipe'])),
        ))
        db.send_create_signal(u'recette', ['Rate'])


    def backwards(self, orm):
        # Deleting model 'Recipe'
        db.delete_table(u'recette_recipe')

        # Deleting model 'Rate'
        db.delete_table(u'recette_rate')
    ...
    models = {
        ...
        u'recette.rate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recette.Recipe']"}),
