...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.transformations'
        db.add_column(u'recette_recipe', 'transformations',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.transformations'
        db.delete_column(u'recette_recipe', 'transformations')
